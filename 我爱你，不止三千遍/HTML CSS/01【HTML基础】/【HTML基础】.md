...
> 本文档是周吉瑞对 Pink 老师课程的总结归纳及补充，转载请注明出处！ 
> 
> 本文档由leonas30200根据黑马程序员2021.11.16发布的基础班课程再次整理。
...
| `placeholder` | 由用户自定义  | 输入框内默认显示的内容              |
...
答：可以给这些表单元素设置 `placeholder属性="值"`。

```html
用户名：<iuput type="text" placeholder="请输入用户名" />
```
